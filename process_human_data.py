...
def get_test_stimuli():
    ...
    test_mazes = maze_stimuli
    test_exits = [path[-1] for path in maze_paths]
    test_entrances = [path[0] for path in maze_paths]
...
def get_human_eye_poss(subject):
    ...
    for maze_number in range(1, 400 + 1):
        ...
        centers_of_mass = filter_saccade_amplitudes(centers_of_mass, EXCLUDE_AMPLITUDE_UNDER, EXCLUDE_AFTER_TARGDIST_UNDER, test_exits[maze_number-1])
